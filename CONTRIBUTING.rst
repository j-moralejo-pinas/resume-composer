...
We welcome contributions to the resume-composer project! This guide will help you get started with contributing to the project.
...
.. code-block:: bash
    ...
    conda create -n resume-composer python=3.13
    conda activate resume-composer
...
Thank you for contributing to the resume-composer project! 🚀
...
.. code-block:: text
    ...
    - **Conda Environment**: [e.g., resume-composer]
